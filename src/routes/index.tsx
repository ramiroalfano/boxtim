...
const slides: Slide[] = [
  {
    ...
    title: <>Construcciones <span className="text-primary">Modulares</span>.</>,
    subtitle: "Soluciones innovadoras en construcción en seco con containers. Rápido, eficiente y sostenible.",
